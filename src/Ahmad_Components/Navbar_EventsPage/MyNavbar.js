      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="ml-auto" >
          ...
          <NavDropdown title="Pages" id="nav-dropdown-pages">
            <NavDropdown.Item><Link to="/HelpingPage" className="dropdown-item" >
              Helping Page
          ...
          <button className="img" style={{ border: 'none', marginLeft: '9px' , padding:"0px" , borderRadius: "7px" , width: "45px", height: "42px"}}>
              <img src="https://images.unsplash.com/photo-1586796676774-c93004ae009f?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fHBvcnRyYWl0JTIwbWFufGVufDB8fDB8fHww"style={{ width: "100%", height: "100%", marginTop: "0px", borderRadius: "6px" }} />
          </button>
        </Nav>
      </Navbar.Collapse>
    </Navbar>
